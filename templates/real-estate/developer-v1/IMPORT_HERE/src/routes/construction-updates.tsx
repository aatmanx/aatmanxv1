...
export const Route = createFileRoute("/construction-updates")({
  head: () => ({
    meta: [
      { title: "Construction Updates — Meridian Estates" },
      { name: "description", content: "Monthly construction progress with photos and completion percentages across all Meridian projects." },
