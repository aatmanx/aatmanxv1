...
export const Route = createFileRoute("/site-visit")({
  head: () => ({
    meta: [
      { title: "Book a Site Visit — Meridian Estates" },
      { name: "description", content: "Schedule a complimentary site visit to any Meridian Estates project. Pickup and drop available." },
