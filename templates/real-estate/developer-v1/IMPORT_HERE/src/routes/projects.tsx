...
export const Route = createFileRoute("/projects")({
  head: () => ({
    meta: [
      { title: "Projects — Meridian Estates" },
      {
        name: "description",
        content:
          "Explore all on-going, upcoming and ready-to-move projects by Meridian Estates across Mumbai, Bengaluru and Gurugram.",
      },
      { property: "og:title", content: "Projects — Meridian Estates" },
