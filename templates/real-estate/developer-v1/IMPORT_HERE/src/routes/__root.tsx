...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Meridian Estates — Premium Real Estate Developer" },
      {
        name: "description",
        content:
          "Meridian Estates crafts premium residences and Grade-A commercial landmarks across India. 48 projects delivered, 12,500+ families served.",
      },
      { name: "author", content: "Meridian Estates" },
      { property: "og:title", content: "Meridian Estates — Premium Real Estate Developer" },
      ...
      { name: "twitter:title", content: "Meridian Estates — Premium Real Estate Developer" },
